...
def index():
    ...
    createString = "CREATE TABLE diagnostic(id INT PRIMARY KEY AUTO_INCREMENT, text VARCHAR(255) NOT NULL);"
    query2 = "INSERT INTO diagnostic (text) VALUES ('MySQL is Working!')"
    query3 = "SELECT * FROM diagnostic;"
    execute_query(db_connection, query1)
    execute_query(db_connection, createString)
    execute_query(db_connection, query2)
    values = execute_query(db_connection, query3)
